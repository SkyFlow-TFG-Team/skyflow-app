...
export default function Profile() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        // 🔹 Perfil desde el backend (igual que tenías)
  ...
  if (!profile) return (
    <div className="flex justify-center items-center min-h-[60vh] text-slate-400 text-lg">
      No se encontró el perfil.
    </div>
  );

  return (
    <div className="max-w-2xl mx-auto mt-10 space-y-6 px-4 pb-12">
